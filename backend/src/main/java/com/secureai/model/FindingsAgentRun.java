...
@Entity
@Table(name = "findings_agent_runs", indexes = {
        @Index(name = "idx_findings_agent_runs_run_id", columnList = "run_id", unique = true)
})
@Getter
@Setter
@NoArgsConstructor
...
public class FindingsAgentRun {
    ...
    private FindingsAgentRunStatus status;
    ...
    @Builder.Default
    private List<FindingsAgentStep> steps = new ArrayList<>();
    ...
    public void addStep(FindingsAgentStep step) {
        step.setRun(this);
        steps.add(step);
    }
}
